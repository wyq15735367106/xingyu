    ...
    <div class="body">
      ...
      <div class="boxs cl">
        <div class="left fl cl">
          <div class="images fl">
            <img src="../../static/image/let1.png" alt="" />
          </div>
          <div class="ri fl">
...
export default {
  ...
  data() {
    return {
      address: "Dd000000000000000000000000000000000000dEaD",
      est: "",
      estusdt: "",
      esc: "",
      command: "DDT",
  ...
  methods: {
    ...
    xia(val) {
      //   console.log(val);
      console.log(document.getElementsByClassName("el-pagination__tota"));
      localStorage.setItem("key", val);
      this.julu(val);
    },
    shang(val) {
    ...
    julu: function (val, command) {
      ...
      this.$api.post(
        ...
        {},
        { page: page, address: this.address, glod: glod },
        (ret) => {
          if (ret.code == "200") {
            // console.log(ret);
